...
class RoiPoolingConv(Layer):
    ...
    def call(self, x, mask=None):
        ...
        #final_output = K.permute_dimensions(final_output,(0,1,3,2))
        #final_output = K.reshape(final_output,(1,self.num_rois, self.nb_channels, self.pool_size, self.pool_size))
